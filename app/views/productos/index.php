                    ...
                    <tbody>
                        <?php foreach ($productos['data'] as $p): ?>
                            <tr class="<?= !$p->activo ? 'row-inactive' : '' ?>">
                                ...
                                <td><a href="<?= url("productos/ver/{$p->id}") ?>" class="text-decoration-none"><code class="text-primary fw-bold tabular-nums" style="cursor:pointer;"><?= $p->sku ?></code></a></td>
                                <td>
                                    <a href="<?= url("productos/ver/{$p->id}") ?>" class="text-decoration-none text-dark">
                                        <strong style="transition:color .2s;"><?= htmlspecialchars($p->nombre) ?></strong>
                                    </a>
