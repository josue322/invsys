...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-3">
    <div>
        <h2 class="h3 mb-0 text-body"><i class="bi bi-arrow-return-left me-2" style="color: var(--primary);"></i>Devoluciones</h2>
        ...
        <form method="GET" action="<?= url('devoluciones') ?>" class="row g-2 align-items-center">
            <div class="col-md-5 col-sm-12">
                <div class="search-pill w-100">
                    ...
                    <input type="text" name="search" value="<?= htmlspecialchars($search ?? '') ?>" placeholder="Buscar por número o departamento...">
                </div>
            </div>
            ...
            <div class="col-md-2 col-sm-12">
                <a href="<?= url('devoluciones') ?>" class="btn btn-link text-muted w-100 text-decoration-none">Limpiar</a>
            </div>
            <?php endif; ?>
        </form>
    </div>
    ...
    <div class="card-body p-0">
        <?php if (empty($devoluciones['data'])): ?>
            <div class="empty-state py-5 text-center">
                <div class="empty-state-icon mx-auto mb-3" style="width: 64px; height: 64px; background: rgba(100,116,139,0.1); border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="bg-primary-subtle text-primary rounded d-flex align-items-center justify-content-center me-2" style="width: 32px; height: 32px;">
