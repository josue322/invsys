        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-transparent border-bottom-0 pt-4 pb-0">
                    <h6 class="fw-bold mb-0"><i class="bi bi-info-circle text-primary me-2"></i>Datos de la Solicitud
                    </h6>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                        <label for="departamento_id" class="form-label fw-semibold text-muted small">Departamento
                            Solicitante <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        <label for="fecha_solicitud" class="form-label fw-semibold text-muted small">Fecha
                            Solicitud</label>
                    ...
                    <div class="mb-3">
                        <label for="estado" class="form-label fw-semibold text-muted small">Estado <span
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="notas" id="notas" class="form-control" rows="3"
                            placeholder="Ej: Materiales para mantenimiento preventivo del mes."></textarea>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <table class="table table-hover align-middle mb-0" id="tabla-productos">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="stock-disp text-muted fw-semibold">0</span> <small
                                            class="unidad-disp text-muted"></small>
                                    </td>
                                    <td>
