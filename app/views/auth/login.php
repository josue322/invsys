        ...
        <div class="login-right">
            <div class="login-form-container">
                <div class="text-center mb-4">
                    <h2 class="fw-bold mb-2">Acceso al Sistema</h2>
                    <p class="text-muted">Ingrese sus credenciales para acceder al panel de control</p>
                </div>

                <?php if (!empty($flash)): ?>
                    <div class="alert alert-<?= $flash['type'] === 'error' ? 'danger' : $flash['type'] ?> alert-dismissible fade show"
                        role="alert" id="login-flash">
                        <i
                            class="bi <?= $flash['type'] === 'error' ? 'bi-exclamation-triangle-fill' : 'bi-check-circle-fill' ?> me-2"></i>
                        <?= $flash['message'] ?>
                ...
                <?php if (filter_var(sysConfig('permitir_registro', '0'), FILTER_VALIDATE_BOOLEAN)): ?>
                    <div class="login-credentials" style="text-align: center; margin-top: 8px;">
                        ...
                        <a href="<?= url('registro') ?>" class="fw-semibold"
                            style="color: var(--primary-color, #6366f1); text-decoration: none;">
