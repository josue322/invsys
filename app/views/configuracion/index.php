                        ...
                        <div class="identity-row">
                            <div class="logo-preview-wrapper">
                                ...
                                <?php if ($logoPath && file_exists(PUBLIC_PATH . '/assets/img/' . $logoPath)): ?>
                                    <img src="<?= asset('img/' . htmlspecialchars($logoPath)) ?>" alt="Logo"
                                        class="logo-preview-img" id="logoPreview">
                                <?php else: ?>
                            ...
                            <div class="identity-fields">
                                ...
                                <input type="text" class="form-control" name="config[nombre_sistema]"
                                    value="<?= htmlspecialchars($cfg['nombre_sistema'] ?? 'InvSys') ?>"
                                    placeholder="Ej: InvSys">
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            <div class="col-sm-6">
                                ...
                                <select class="form-select" name="config[moneda_codigo]">
                                    ...
                                    <option value="USD" <?= $mc === 'USD' ? 'selected' : '' ?>>USD — Dólar americano
                                    </option>
                                    <option value="EUR" <?= $mc === 'EUR' ? 'selected' : '' ?>>EUR — Euro</option>
                                    <option value="PEN" <?= $mc === 'PEN' ? 'selected' : '' ?>>PEN — Sol peruano</option>
                                    <option value="COP" <?= $mc === 'COP' ? 'selected' : '' ?>>COP — Peso colombiano
                                    </option>
                                    <option value="ARS" <?= $mc === 'ARS' ? 'selected' : '' ?>>ARS — Peso argentino
                                    </option>
                                    <option value="CLP" <?= $mc === 'CLP' ? 'selected' : '' ?>>CLP — Peso chileno</option>
                                    <option value="BRL" <?= $mc === 'BRL' ? 'selected' : '' ?>>BRL — Real brasileño
                                    </option>
                                </select>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select class="form-select" name="config[zona_horaria]">
                                    ...
                                    <option value="America/Lima" <?= $tz === 'America/Lima' ? 'selected' : '' ?>>
                                        América/Lima (UTC-5)</option>
                                    <option value="America/Bogota" <?= $tz === 'America/Bogota' ? 'selected' : '' ?>>
                                        América/Bogotá (UTC-5)</option>
                                    <option value="America/New_York" <?= $tz === 'America/New_York' ? 'selected' : '' ?>>
                                        América/New York (UTC-5)</option>
                                    <option value="America/Argentina/Buenos_Aires"
                                        <?= $tz === 'America/Argentina/Buenos_Aires' ? 'selected' : '' ?>>América/Buenos
                                        Aires (UTC-3)</option>
                                    <option value="America/Sao_Paulo" <?= $tz === 'America/Sao_Paulo' ? 'selected' : '' ?>>
                                        América/São Paulo (UTC-3)</option>
                                    <option value="Europe/Madrid" <?= $tz === 'Europe/Madrid' ? 'selected' : '' ?>>
                                        Europa/Madrid (UTC+1)</option>
                                </select>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <select class="form-select" name="config[formato_fecha]">
                                    ...
                                    <option value="DD/MM/YYYY" <?= $df === 'DD/MM/YYYY' ? 'selected' : '' ?>>DD/MM/YYYY
                                    </option>
                                    <option value="MM/DD/YYYY" <?= $df === 'MM/DD/YYYY' ? 'selected' : '' ?>>MM/DD/YYYY
                                    </option>
                                    <option value="YYYY-MM-DD" <?= $df === 'YYYY-MM-DD' ? 'selected' : '' ?>>YYYY-MM-DD
                                    </option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="config-section">
                    ...
                    <div class="config-section-body">
                            ...
                            <div class="col-sm-6">
                                <label class="form-label">Registros por página
                                    <i class="bi bi-info-circle text-muted ms-1" data-bs-toggle="tooltip"
                                        title="Valor por defecto global. Cada usuario puede ajustar temporalmente la cantidad de registros desde el selector en cada listado."></i>
                                </label>
                        ...
                        <div class="config-toggle-item">
                            ...
                            <div class="toggle-switch" data-config="permitir_stock_negativo"
                                data-checked="<?= ($cfg['permitir_stock_negativo'] ?? '0') === '1' ? '1' : '0' ?>">
                                <input type="hidden" name="config[permitir_stock_negativo]"
                                    value="<?= ($cfg['permitir_stock_negativo'] ?? '0') === '1' ? '1' : '0' ?>">
                                <span
                                    class="toggle-track <?= ($cfg['permitir_stock_negativo'] ?? '0') === '1' ? 'active' : '' ?>">
                        ...
                        <div class="config-toggle-item">
                            <div>
                                ...
                                <span class="config-toggle-desc">Generar alerta de reorden al alcanzar stock
                                    mínimo</span>
                            </div>
                            <div class="toggle-switch" data-config="reorden_automatico"
                                data-checked="<?= ($cfg['reorden_automatico'] ?? '1') === '1' ? '1' : '0' ?>">
                                <input type="hidden" name="config[reorden_automatico]"
                                    value="<?= ($cfg['reorden_automatico'] ?? '1') === '1' ? '1' : '0' ?>">
                                <span
                                    class="toggle-track <?= ($cfg['reorden_automatico'] ?? '1') === '1' ? 'active' : '' ?>">
                                    <span class="toggle-thumb"></span>
                                </span>
                            </div>
                        </div>
                ...
                <div class="config-section">
                    ...
                    <div class="config-section-body">
                        ...
                        <div class="config-toggle-item">
                            ...
                            <div class="toggle-switch" data-config="tema_defecto" data-on="dark" data-off="light"
                                data-checked="<?= ($cfg['tema_defecto'] ?? 'light') === 'dark' ? '1' : '0' ?>">
                                <input type="hidden" name="config[tema_defecto]"
                                    value="<?= $cfg['tema_defecto'] ?? 'light' ?>">
                                <span
                                    class="toggle-track <?= ($cfg['tema_defecto'] ?? 'light') === 'dark' ? 'active' : '' ?>">
                                    <span class="toggle-thumb"></span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="config-toggle-item">
                            ...
                            <div class="toggle-switch" data-config="sidebar_colapsable"
                                data-checked="<?= ($cfg['sidebar_colapsable'] ?? '1') === '1' ? '1' : '0' ?>">
                                <input type="hidden" name="config[sidebar_colapsable]"
                                    value="<?= ($cfg['sidebar_colapsable'] ?? '1') === '1' ? '1' : '0' ?>">
                                <span
                                    class="toggle-track <?= ($cfg['sidebar_colapsable'] ?? '1') === '1' ? 'active' : '' ?>">
                                    <span class="toggle-thumb"></span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="config-toggle-item">
                            ...
                            <div class="toggle-switch" data-config="densidad_compacta"
                                data-checked="<?= ($cfg['densidad_compacta'] ?? '0') === '1' ? '1' : '0' ?>">
                                <input type="hidden" name="config[densidad_compacta]"
                                    value="<?= ($cfg['densidad_compacta'] ?? '0') === '1' ? '1' : '0' ?>">
                                <span
                                    class="toggle-track <?= ($cfg['densidad_compacta'] ?? '0') === '1' ? 'active' : '' ?>">
                                    <span class="toggle-thumb"></span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="config-toggle-item">
                            ...
                            <div class="toggle-switch" data-config="animaciones"
                                data-checked="<?= ($cfg['animaciones'] ?? '1') === '1' ? '1' : '0' ?>">
                                <input type="hidden" name="config[animaciones]"
                                    value="<?= ($cfg['animaciones'] ?? '1') === '1' ? '1' : '0' ?>">
                ...
                <div class="config-section">
                    ...
                    <div class="config-section-body">
                        ...
                        <div class="config-toggle-item">
                            ...
                            <div class="toggle-switch" data-config="alertas_email"
                                data-checked="<?= ($cfg['alertas_email'] ?? '0') === '1' ? '1' : '0' ?>">
                                <input type="hidden" name="config[alertas_email]"
                                    value="<?= ($cfg['alertas_email'] ?? '0') === '1' ? '1' : '0' ?>">
                                <span
                                    class="toggle-track <?= ($cfg['alertas_email'] ?? '0') === '1' ? 'active' : '' ?>">
                                    <span class="toggle-thumb"></span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="config-toggle-item">
                            ...
                            <div class="toggle-switch" data-config="alertas_seguridad"
                                data-checked="<?= ($cfg['alertas_seguridad'] ?? '1') === '1' ? '1' : '0' ?>">
                                <input type="hidden" name="config[alertas_seguridad]"
                                    value="<?= ($cfg['alertas_seguridad'] ?? '1') === '1' ? '1' : '0' ?>">
                                <span
                                    class="toggle-track <?= ($cfg['alertas_seguridad'] ?? '1') === '1' ? 'active' : '' ?>">
                                    <span class="toggle-thumb"></span>
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="config-section-body">
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="number" class="form-control" name="config[tiempo_bloqueo_minutos]"
                                    value="<?= htmlspecialchars($cfg['tiempo_bloqueo_minutos'] ?? '15') ?>" min="1"
                                    max="120">
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="config-toggle-item">
                            <div>
                                ...
                                <span class="config-toggle-desc">Los usuarios pueden crear su propia cuenta desde la
                                    página de login</span>
                            </div>
                            <div class="toggle-switch" data-config="permitir_registro"
                                data-checked="<?= ($cfg['permitir_registro'] ?? '0') === '1' ? '1' : '0' ?>">
                                <input type="hidden" name="config[permitir_registro]"
                                    value="<?= ($cfg['permitir_registro'] ?? '0') === '1' ? '1' : '0' ?>">
                                <span
                                    class="toggle-track <?= ($cfg['permitir_registro'] ?? '0') === '1' ? 'active' : '' ?>">
                                    <span class="toggle-thumb"></span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="config-item mt-3" id="rolRegistroWrapper"
                            style="display: <?= ($cfg['permitir_registro'] ?? '0') === '1' ? 'block' : 'none' ?>;">
                            <label class="form-label"><i class="bi bi-person-badge me-1"></i>Rol para usuarios
                                registrados</label>
                            ...
                            <small class="text-muted">Rol asignado automáticamente a nuevos usuarios que se registren de
                                forma pública</small>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="config-section-body">
                        ...
                        <div class="config-toggle-item mb-3">
                            <div>
                                ...
                                <span class="config-toggle-desc">Activar para usar un servidor SMTP en vez del mail()
                                    nativo de PHP</span>
                            </div>
                            <div class="toggle-switch" data-config="smtp_activo"
                                data-checked="<?= ($cfg['smtp_activo'] ?? '0') === '1' ? '1' : '0' ?>">
                                <input type="hidden" name="config[smtp_activo]"
                                    value="<?= ($cfg['smtp_activo'] ?? '0') === '1' ? '1' : '0' ?>">
                        ...
                        <div id="smtpFields">
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-select" name="config[smtp_port]">
                                        ...
                                        <option value="2525" <?= $sp === '2525' ? 'selected' : '' ?>>2525 (Alternativo)
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <div class="row g-3 mb-3">
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-select" name="config[smtp_encryption]">
                                        ...
                                        <option value="tls" <?= $se === 'tls' ? 'selected' : '' ?>>TLS (Recomendado)
                                        </option>
                                        <option value="ssl" <?= $se === 'ssl' ? 'selected' : '' ?>>SSL</option>
                                        <option value="none" <?= $se === 'none' ? 'selected' : '' ?>>Sin encriptación
                                        </option>
                                    </select>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-select" name="config[smtp_auth]">
                                        ...
                                        <option value="1" <?= $sa === '1' ? 'selected' : '' ?>>Sí (usuario/contraseña)
                                        </option>
                            ...
                            <!-- Botón de prueba -->
                            <div class="d-flex align-items-center gap-2 mt-3 p-3 rounded"
                                style="background: var(--bg-secondary);">
                                <i class="bi bi-send text-warning"></i>
                                <small class="text-muted flex-grow-1">Guarda primero, luego envía un correo de prueba
                                    para verificar la configuración.</small>
            ...
            <div class="modal-content border-0 shadow">
                <div class="modal-header border-bottom-0 pb-0">
                    <h5 class="modal-title fw-bold">
                        <i class="bi bi-envelope-paper-heart text-warning me-2"></i>Prueba de Correo SMTP
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p class="text-muted mb-4" style="font-size: 0.95rem;">
                        Ingresa la dirección de correo a la que deseas enviar el mensaje de prueba. Asegúrate de haber <strong>guardado</strong> tu configuración antes de realizar la prueba.
                    </p>
                    <div class="mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" class="form-control border-start-0 ps-0" id="smtpTestEmail" placeholder="usuario@correo.com">
                        </div>
                    </div>
                </div>
                <div class="modal-footer border-top-0 pt-0">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Cancelar</button>
                    <button type="button" class="btn btn-warning px-4 text-dark fw-medium" id="btnConfirmTestMail">
