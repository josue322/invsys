...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const STORAGE_KEY = 'invsys_draft_movimiento';
    const inputsToSave = ['producto_id', 'tipo', 'cantidad', 'proveedor_id', 'destino', 'referencia', 'numero_lote', 'fecha_vencimiento'];
        ...
        try {
            ...
            inputsToSave.forEach(id => {
                if (state[id]) {
                    ...
                    if (el) {
                        el.value = state[id];
                        // Disparar evento change para que otros scripts (como la lógica de UI de lotes) se actualicen
